                           ...
                           <tr>         
                              ...
                              <td>
                                 <a href="#" id="editbtn" onClick=" 
                                    modal.style.display='block'; modal.children[0].children[1].innerHTML ='Edit Data Karyawan'; modal.children[0].children[2].children[1].children[0].innerHTML = 'Edit Data';
